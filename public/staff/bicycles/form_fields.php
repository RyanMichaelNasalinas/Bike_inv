...
<dl>
  ...
  <dd>
    <select name="bicycle[condition_id]">
      <option value=""></option>
    <?php foreach(Bicycle::CONDITION_OPTIONS as $condition_id => $cond_name) { ?>
      <option value="<?php echo $condition_id; ?>"<?php if($bicycle->condition_id == $condition_id){ echo 'selected'; } ?>><?php echo $cond_name; ?></option>
    <?php } ?>
    </select>
  </dd>
</dl>
